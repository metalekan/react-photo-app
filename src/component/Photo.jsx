...
const Photo = () => {
  ...
  return (
    <div className='Photo border border-3 shawdow-lg rounded-3 p-2 mb-4'>
        ...
        <div className="filters my-4 d-flex gap-2 justify-content-center">
            <div className='btn btn-warning' onClick={()=> handleSelection("safari")}>Safari</div>
            <div className='btn btn-warning' onClick={()=> handleSelection("coding")}>Coding</div>
            <div className='btn btn-warning' onClick={()=> handleSelection("dark")}>Dark</div>
            <div className='btn btn-warning' onClick={()=> handleSelection("model")}>Model</div>
        </div>
        ...
        <div className="page-buttons d-flex gap-2 mt-2">
            {page > 1 && (<button className='btn btn-warning' onClick={()=> setPage(page - 1)}>Previous</button>)}
